...
export default class Facemasks extends React.Component {
  state = {
    loading: true,
    items: null,
    stock: null,
  ...
  async componentDidMount() {
    const urlProduct =
      'https://thawing-anchorage-40506.herokuapp.com/https://bad-api-assignment.reaktor.com/v2/products/facemasks';
        ...
        {this.state.loading ? (
          ...
          <div>
            <div className="card-list">
              <h1>Current facemasks availability</h1>
